...
const navigation = [
  ...
  { name: 'Component Analysis', href: '/components', icon: CpuChipIcon },
  { name: 'Scenario Analysis', href: '/scenarios', icon: ExclamationTriangleIcon },
  { name: 'Supplier Analysis', href: '/suppliers', icon: UsersIcon },
      ...
      <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
        <div className="flex items-center flex-shrink-0 px-4">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <h2 className="text-lg font-semibold text-gray-900">AI Framework</h2>
      ...
      <div className="flex-shrink-0 flex border-t border-gray-200 p-4">
        <div className="flex items-center w-full">
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-gray-500">9 capabilities active</p>
          </div>
